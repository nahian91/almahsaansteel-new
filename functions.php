...
function almahsaansteel_enqueue_assets() {
    ...
    wp_enqueue_style('slicknav-style', get_template_directory_uri() . '/assets/css/slicknav.min.css', array(), '1.0');
    ...
    wp_enqueue_script('slicknav-script', get_template_directory_uri() . '/assets/js/slicknav.min.js', array('jquery'), '1.0', true);
